@sanity   @skip
Feature: ACM QA API Sanity

Scenario: ACM QA API Sanity Check
  Then it should post the ACM QA rules
  Then it should return the ACM QA rules
  ...
  And it should return rule "2" condition "1" with duration "1" percentage "100" suspension "300" is suppress all "false" facility "Site-34" unit "" bed ""
