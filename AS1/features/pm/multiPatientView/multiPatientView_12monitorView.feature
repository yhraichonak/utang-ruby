...
Feature: Multi-Patient View - 12 View
8 View
Header:
...
AS1-3955
  MPV - Display 6+ views in rows of 3 by default (Web)
    All views above 4 should display by default in rows of 3.
      12 view should be 4 rows of 3 monitors each
...
Background:
  ...
  And I have 12 or more patients added to My Patients List
  Then I should see the patient list screen
 ...
 @critical @TMS:581579
Scenario: Multi-Patient View - 12 View
  ...
  And I should see the 12 full monitors should split into 4 rows and 3 monitors on each row
#  And waveforms are streaming in all 12 monitors (AS1-5720)
