@automated @pm-multi_patient_view @TMS:582893 @ISSUE:AS1-6799
Feature: pm_mpv_tertiary_secondary_sort
  ...
  Scenario: PM - MPV Sort Dropdown Options
    When I click the "Second Sort by" field and should see the following options:
      | None       |
      | Unit       |
      | Last Name  |
      | First Name |
  ...
  Scenario: PM - MPV Group/Sort icon becomes active when a sort is applied
    When I click on second Sort By dropdown and select "Last Name"
  ...
  Scenario: PM - MPV "First Name" Sorting (Ascending)
    When I click on second Sort By dropdown and select "First Name"
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "Gender" Sorting (Ascending)
    When I click on second Sort By dropdown and select "Gender"
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "Bed" Sorting (Ascending)
    When I click on second Sort By dropdown and select "Bed"
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
