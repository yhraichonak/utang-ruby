@automated @pm-multi_patient_view @TMS:582881
Feature: pm_mpv_tertiary_group
  ...
  Scenario: PM - MPV Group Dropdown Options
    Then I click the "Group by" field and should see the following options:
          | None       |
          | Unit       |
          | Last Name  |
          | First Name |
  ...
  Scenario: PM - MPV Group/Sort Icon Becomes Active when a Group is Applied
    And I click on Group By dropdown and select "Last Name"
  ...
  Scenario: PM - MPV "Last Name" Grouping (Ascending)
  ...
  Scenario: PM - MPV Invert "Last Name" Grouping (Descending)
    When I click on Group By dropdown and select "Last Name"
  ...
  Scenario: PM - MPV "First Name" Grouping (Ascending)
  ...
  Scenario: PM - MPV  Invert "First Name" Grouping (Descending)
    When I click on Group By dropdown and select "First Name"
    And I click on the Group By invert button
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "Unit" Grouping (Ascending)
  ...
  Scenario: PM - MPV Invert "Unit" Grouping (Descending)
    When I click on Group By dropdown and select "Unit"
    And I click on the Group By invert button
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "Age" Grouping (Ascending)
  ...
  Scenario: PM - MPV Invert "Age" Grouping (Descending)
    When I click on Group By dropdown and select "Age"
    And I click on the Group By invert button
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "Gender" Grouping (Ascending)
  ...
  Scenario: PM - MPV Invert "Gender" Grouping (Descending)
    When I click on Group By dropdown and select "Gender"
    And I click on the Group By invert button
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "Bed" Grouping (Ascending)
  ...
  Scenario: PM - MPV  Invert "Bed" Grouping (Descending)
    When I click on Group By dropdown and select "Bed"
    And I click on the Group By invert button
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
  ...
  Scenario: PM - MPV "None" Grouping (Ascending)
  ...
  Scenario: PM - MPV Invert "None" Grouping (Descending)
    When I click on Group By dropdown and select "None"
    And I click on the Group By invert button
    And I click the ok button on Group / Sort window
    Then I should see Multi Patient View screen with condensed monitors selected in full screen mode
