...
Feature: Live Monitor Smoke Test
  ...
  @obsolete
  Scenario: Live Monitor Nihon Khoden
    Given I login to a test site "nihon_khoden" with user "raytrejo" and pass "XXXXX"
    Then I should see the patient list screen
    When I click "Census" on the List
    Then I should see the patient list screen
    When I click on "Rufus Weller," in patient list
