...
Feature: Snippet Tools - Save PRN - Provide Snippet type to Server for PDF
...
@critical @TMS:329179
Scenario: Snippet Tools - Save PRN - Provide Snippet type to Server for PDF
  ...
  When I select snippet doc type of "PRN"
  Then I should see the Description field with header "PRN"
  ...
  Then I should see the record of the snippetdocument saved with SnippetType equal to 0