@automated @TMS:40309  @cardio @cardio-search @bvt
Feature: Search by Age and First Name
  As an AS1 user
  I want to search for patients using the search form
  So I can find patients by Age and First Name

  TestRail Id: C40309

  Scenario: Search by AGE and First Name
    ...
    And   I enter "[props.CP_FNAME]" in the cardio "First" field
