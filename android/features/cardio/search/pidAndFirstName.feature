@automated @TMS:40311  @cardio @cardio-search @bvt
Feature: Search by PID and First Name
  As an AS1 user
  I want to search for patients using the search form
  So I can find patients by PID and First Name

  TestRail Id: C40311

  Scenario: Search by MRN and First name
    ...
    When  I enter "[props.CP_FNAME]" in the cardio "First" field
