...
#  Exception: When in backgrounded mode, the screen may briefly show where the user left-off, and then transition to the new context.
  ...
  Scenario: ASCOM - C3P0 launch to PM Monitor screen (Welcome Screen, Backgrounded Application, Live Monitor)
    ...
    And I open pm-mon Ascom C3PO url with payload [props.C3POA_WITHOUT_TIME_PAYLOAD]
  ...
  Scenario: ASCOM - C3P0 launch to PM Monitor screen (Welcome Screen, Backgrounded Application, Historic Monitor)
    When I move app to background
    And I open pm-mon Ascom C3PO url with payload [props.C3POA_WITH_TIME_PAYLOAD]
