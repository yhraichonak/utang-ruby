...
Feature: Login with a User with Invalid Vendor Credentials
  As an AS1 user
  I should not be able to login to the site with invalid vendor credentials

  TestRail Id: C158831

  Scenario: Invalid Vendor Credentials
...
#    And I should complete the invalid vendor login
#    And I set vendor credential password in AMP
