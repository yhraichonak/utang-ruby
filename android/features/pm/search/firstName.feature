@automated @TMS:40312  @pm @pm-search @regression @bvt
Feature: Search: By First Name
  As an AS1 user
  I want view a Search for patients by First Name
  ...
  Scenario: Search: By First Name
    ...
    When I enter "[props.CP_FNAME]" in the field
