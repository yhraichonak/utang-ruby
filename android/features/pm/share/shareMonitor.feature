@automated @TMS:40305  @pm @pm-share @regression @bvt
Feature: Share: Share Live Monitor
  As an AS1 user
  I want to share the Monitor
  So that I can make sure I can share the monitor screen

  TestRail Id: C40305

  Scenario: Share: Share Live Monitor
