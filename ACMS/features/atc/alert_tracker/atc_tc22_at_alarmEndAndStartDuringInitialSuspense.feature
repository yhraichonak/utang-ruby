...
@clear_atc_flights @TMS:584266
Feature: alertTracker_tc22_alarmEndAndStartDuringInitialSuspense
  ...
  Scenario: flight in which the alarm ends and starts again in the Initial Suspense state
    ...
    And FT: User sees the "Total Time" on the flight entry stop at "00:43" within 3 second range
