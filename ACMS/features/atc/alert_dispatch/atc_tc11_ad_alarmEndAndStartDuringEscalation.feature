...
Feature: airDispatch_tc11_alarmEndAndStartDuringEscalation
  As an Air Traffic Controller user
  I want to generate a flight with whose alarm ends and starts during an escalation
  So that I can verify a flight will continue to escalate/complete properly after an alarm end and start event
