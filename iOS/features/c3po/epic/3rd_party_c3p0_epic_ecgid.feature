@automated @TMS:328916
Feature: 3rd_party_c3p0_epic_ecgid
              As a C3P0 user
...
C3PO links to a patient context should open directly to the specified context without visual indication of the navigational elements in-between (such as site list).
        ...
        Background:
            Given I reset the AS1 app
             ...
             When I generate ecg epic C3PO url with query TEST=1234567890&ecgid=[props.DP_ECG_ID]&ad=[props.C3PO_USER]&asmpid=[props.DP_ASMPID]
        ...
        Scenario: EPIC - C3P0 launch to ECG screen by ECG ID amd ASMPID (Welcome Screen, Force Closed Application)
