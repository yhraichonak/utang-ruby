...
C3PO links to a patient context should open directly to the specified context without visual indication of the navigational elements in-between (such as site list).
        ...
        Background:
            Given I reset the AS1 app
             ...
             When I generate pm-evt mh C3PO url with query TEST=1234567890&ad=[props.C3PO_USER]&dob=&mrn=[props.DP_MRN]

        Scenario: MH - C3P0 launch to PM Events screen by SiteID (Welcome Screen, Backgrounded Application)
             When I move app to background
              And I navigate to the generated mobile C3PO url
             Then I should see the Events screen of [props.DP_FULL_NAME] patient

        Scenario: MH - C3P0 launch to PM Events screen by SiteID (Welcome Screen, Force Closed Application)
             When I force close app
              And I navigate to the generated mobile C3PO url
             Then I should see the Events screen of [props.DP_FULL_NAME] patient

        Scenario: MH - C3P0 launch to PM Events screen by SiteID (Sites List, Backgrounded Application)
        ...
        Scenario: MH - C3P0 launch to PM Events screen by SiteID (Sites List, Force Closed Application)
             When I sign into AS1
             Then I should see the Site List screen
             When I force close app
              And I navigate to the generated mobile C3PO url
