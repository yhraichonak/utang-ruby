@automated @TMS:328915
Feature: 3rd_party_c3p0_ccf_events
              As a C3P0 user
...
C3PO links to a patient context should open directly to the specified context without visual indication of the navigational elements in-between (such as site list).
        ...
        Background:
            Given I reset the AS1 app
             ...
             When I generate pm-evt ccf C3PO url with query TEST=1234567890&bed=[props.C3PO_BED]&unit=[props.C3PO_UNIT]&ad=[props.C3PO_USER]



        Scenario: CCF - C3P0 launch to PM Events screen (Welcome Screen, Backgrounded Application)
        ...
        Scenario: CCF - C3P0 launch to PM Events screen (Welcome Screen, Force Closed Application)
             When I force close app
              And I navigate to the generated mobile C3PO url
             Then I should see the Events screen of [props.C3PO_FULL_NAME] patient

        Scenario: CCF - C3P0 launch to PM Events screen (Sites List, Backgrounded Application)
        ...
        Scenario: CCF - C3P0 launch to PM Events screen (Sites List, Force Closed Application)
             When I sign into AS1
             Then I should see the Site List screen
             When I force close app
              And I navigate to the generated mobile C3PO url
