@regression @hotfix @automated @TMS:580679
Feature: About Screen EU Authorized Representative
              As an AS1 user
...
TestRail Id: C580679
        ...
        Scenario: Verify the EU Authorized Representative Information
             ...
             Then I should see the About screen
              And I verify the EU Authorized Representative Info on the About screen
