@cardio @regression @automated @TMS:40250
Feature: Serial Compare Screen
              As an AS1 user
              I want view a Serial Compare Screen
...
TestRail Id: C40250
        ...
        Scenario: Serial Presentation Screen
             ...
             Then I should see the following info in patient banner on Serial Presentation screen
                  | name   | [props.CP_FULL_NAME] |
                  | gender | [props.CP_SEX]       |
