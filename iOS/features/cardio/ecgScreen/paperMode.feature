@cardio @regression @automated @TMS:148505
Feature: ECG Screen - Paper Mode
              As an AS1 user
              I want view a 12 Lead Zoom Screen
  So that I can make sure a patient's ECG displays with paper like colors
...
TestRail Id: C148505
        ...
        Scenario: Paper Mode View
             When I click on the paper mode button
             Then I should see the ecg screen in paper mode
             ...
             When I double click on 10 sec Lead "V2"
             Then I should see the Lead "V2" zoom lead window
