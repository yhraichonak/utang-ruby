@pm @regression @automated @TMS:40260
Feature: Events - No Alarm Events
              As an AS1 user
...
TestRail Id: C40260
        ...
        Scenario: Alarm Events (No Events)
             ...
             Then I should see the Events screen with no events listed
